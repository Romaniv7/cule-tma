...
export function JerseyCard({
  ...
  console.debug('skinId:', effectiveSkinId, 'url:', skinUrl) // ← вставляєш тут
  // якщо є скін — показуємо лише його; якщо ні — наш базовий фон
  ...
  return (
    ...
    >
      ...
      <Text
        ...
        textAlign="center" fontWeight="900" fontSize={['32px','24px']}
      ...
      <Box position="absolute" inset="0" display="grid" placeItems="center">
        {level === 1 ? (
          <svg viewBox="0 0 400 600" style={{ width: '68%', filter: 'drop-shadow(0 14px 30px rgba(0,0,0,.45))' }}>
            <path d="M250 520H160V280L95 350V250L205 150H250V520Z" fill="#FFFFFF"/>
          </svg>
        ) : (
          <Heading
            as="div" fontWeight="900" lineHeight="1"
            fontSize={['200px','240px','280px']} color="white"
          >
            {level}
          </Heading>
        )}
